      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="font-mono text-sm text-accent hidden sm:block">
              dipesh.dev
            </span>
          </motion.a>
          ...
          <ul className="hidden md:flex items-center gap-8" role="list">
            ...
            <motion.a
              ...
              download="Dipesh_Chaulagain_CV.pdf"
        ...
        {menuOpen && (
          ...
          >
            {navLinks.map((link, i) => (
              ...
              >
                <span className="text-accent block text-center text-sm mb-1">
                  0{i + 1}.
                </span>
                {link.label}
              </motion.a>
